...
//                menu.findItem(R.id.tentang).isVisible = false
//            }
...
//    private fun handleMenuSelection(menuItem: m): Boolean {
//        return when (menuItem.itemId) {
//            R.id.tentang -> {
//                context.startActivity(Intent(context, Tentang::class.java))
//                true
//            }
//            else -> false
//        }
